      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <h1 className="text-5xl lg:text-7xl font-display font-bold leading-[1.1] mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white/70 drop-shadow-sm">
              Experience the <br/>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <button className="px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-violet-600 text-white font-semibold text-lg shadow-[0_0_40px_-10px_rgba(79,70,229,0.5)] hover:shadow-[0_0_60px_-10px_rgba(79,70,229,0.6)] hover:-translate-y-1 transition-all duration-300 flex items-center gap-2 group">
                Start Building <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              
              <button className="px-8 py-4 rounded-2xl bg-white/5 border border-white/10 text-white font-semibold text-lg backdrop-blur-md hover:bg-white/10 transition-all duration-300 flex items-center gap-2">
                <Play className="w-5 h-5 fill-current" /> Watch Demo
              </button>
            </div>
            
            <div className="mt-12 flex items-center justify-center lg:justify-start gap-8 text-sm text-slate-400">
          ...
          <div className="lg:w-1/2 relative lg:h-[600px] w-full flex items-center justify-center perspective-1000">
            ...
            {/* Main Dashboard Card */}
            <GlassCard className="w-full max-w-md aspect-[4/3] p-6 animate-float relative z-20 transform rotate-y-6 rotate-x-6 hover:rotate-0 transition-transform duration-700">
              {/* Fake UI Header */}
